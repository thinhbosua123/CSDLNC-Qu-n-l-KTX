...
--Bảng Nhân Viên
insert into NhanVien values('NV01',N'Phạm Quỳnh Như','0123456789','10-10-2000','nhu@gmail.com',0,'KT')
insert into NhanVien values('NV02',N'Phạm Quỳnh Như','012345566','15-10-1999','qiunhnhunhu@gmail.com',0,'KT')
insert into NhanVien values('NV03',N'Lê Trọng Khanh','0123456789','21-04-2003','khanh@gmail.com',1,'BV')
insert into NhanVien values('NV04',N'Lê Trọng Khanh','0123456789','10-06-1993','khanhvipro5000@gmail.com',1,'BV')
insert into NhanVien values('NV05',N'Đỗ Hồng lộc','0123456789','28-08-2003','loc@gmail.com',0,'TN')
insert into NhanVien values('NV06',N'Đỗ Hồng lộc','0123456789','28-08-2003','thinhbosua123@gmail.com',0,'TN')
...
insert into SinhVien values ('SV01',N'Nguyễn Thị Thùy Duyên','0011223344','03-03-2001','manh@gmail.com','098761325',1,'A101')
insert into SinhVien values ('SV02',N'Phạm Hoài Nam','0011223344','03-04-2000','hoang@gmail.com','098761325',1,'A101')
insert into SinhVien values ('SV03',N'Trang Hạnh Nhi','0011223344','03-03-1999','lan@gmail.com','098761325',0,'A102')
...
--Bảng Hợp đồng
insert into HopDong values ('HD01',N'NV05','SV01',N'Hợp đồng ở KTX','03-04-2024','03-03-2026',50000,0,'chu co')
insert into HopDong values ('HD02',N'NV05','SV02',N'Hợp đồng ở KTX','10-04-2024','10-03-2016',50000,0,'chu co')
insert into HopDong values ('HD03',N'NV05','SV03',N'Hợp đồng ở KTX','03-05-2024','03-03-2025',50000,0,'chu co')
insert into HopDong values ('HD04',N'NV06','SV04',N'Hợp đồng ở KTX','03-03-2025','03-03-2027',50000,0,'chu co')
insert into HopDong values ('HD05',N'NV06','SV05',N'Hợp đồng ở KTX','03-03-2024','03-03-2025',50000,0,'chu co')
insert into HopDong values ('HD06',N'NV06','SV06',N'Hợp đồng ở KTX','03-03-2025','03-03-2027',50000,0,'chu co')
select *from HopDong
...
--Câu 1: Đếm số lượng hợp đồng được tạo mới trong tháng 03-2024
select count(NgayLap) as N'Số Lượng Hợp Đồng' from HopDong where NgayLap between '2024/03/01' AND '2024/03/31';
...
--Câu 3: Thống kế ra danh sách các sinh viên đăng ký vào ở KTX trong tháng 03-2024
...
where NgayLap between '2024/03/01' AND '2024/03/31' and sv.MaSinhVien = hd.MaSinhVien;
